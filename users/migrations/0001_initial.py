    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('citizen', 'Citizen'), ('government_admin', 'Government Admin')], default='citizen', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='government_admin', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'permissions': [('approve_ministries', 'Can approve or reject ministry registrations'), ('manage_reports', 'Can manage citizen-reported issues'), ('assign_reports', 'Can assign reports to specific ministries')],
            },
        ),
        migrations.CreateModel(
            name='Profile',
